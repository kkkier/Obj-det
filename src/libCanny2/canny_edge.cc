...
main(int argc, char *argv[])
{
	...
	char *edgefilename = NULL; /* Name of the output image */
   ...
   ***************************************************************************/
	if(argc < 6){
		fprintf(stderr,"\n<USAGE> %s image sigma tlow thigh outputimg [writedirim]\n",
						argv[0]);
		...
		fprintf(stderr,"       outputimg: result file ");
	...
	if(argc == 7) dirfilename = edgefilename;
   ...
   ***************************************************************************/
   ...
   if(dirfilename != NULL){
		 sprintf(composedfname, "%s_s_%3.2f_l_%3.2f_h_%3.2f.fim", edgefilename,
						 sigma, tlow, thigh);
   ...
   ***************************************************************************/
   sprintf(outfilename, "%s_s_%3.2f_l_%3.2f_h_%3.2f.pgm", edgefilename,
					 sigma, tlow, thigh);
