  ...
  : QWidget( parent, name )
{
  ...
  /*******************************/
  Q3HBox        *hbImg  = new Q3HBox( this, "himg");
  rsImg = new QtResizeImg (hbImg, "current image");
    
  /***********************************/
  /*   make a "coordinate display"   */
  /***********************************/
  Q3HBox        *hbCoord  = new Q3HBox( this, "hbcoord");
  ...
  rsImg->setCursor( Qt::crossCursor );

  /***********************************/
  /*   create a scrolling facility   */
  /***********************************/
  Q3HBox  *hbScrollLab  = new Q3HBox( this, "hbscroll");
  qScrollLabel = new QLabel( " 1/ 1", hbScrollLab );

  Q3HBox  *hbScroll  = new Q3HBox( this, "hbscroll");
  //qSlider = new QSlider( Horizontal, hbScroll, "slider" );
  qSlider = new QScrollBar( Qt::Horizontal, hbScroll, "slider" );
