...
public slots:
  ...
  void slotSetExtractFromWholeImageOnOff ( int   state );
...
private:
  ...
  QRadioButton* selSURF128;
    ...
    QCheckBox*    chkExtractFromWholeImage;
