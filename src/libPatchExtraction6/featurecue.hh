...
const float DEFAULTSAMPLEPERAREA = 50.0/5000;

const int EXTRACTEDPATCH_SIZE = 33;
/*************************/
/*   Class Definitions   */
/*************************/
...
protected:
  ...
  void collectRandomPoints        ( int insiders, int outsiders );
  ...
  void extractAllPatches        ( bool bFeaturesExtracted=false,
                                  bool bVerbose=true,
                                  bool bExtractPatches=false );
  void extractAllPatches_OBJnBKG( bool bFeaturesExtracted=false,
							      bool bVerbose=true,
								  bool bExtractPatches=false );
  void applyVlfeatSIFT			(vector<FeatureVector>& vResults);
...
protected:
  ...
  vector<int>           m_vPtIdzs; // the index of interet points inside the bounding box in m_vPoints, same length with m_vPonitsInside
