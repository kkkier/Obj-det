...
**
** Created: Wed Jan 16 09:20:32 2013
...
QMetaObject* VeriGUI::staticMetaObject()
{
    ...
    static const QUMethod slot_14 = {"slotSetVerHistEqOnOff", 1, param_slot_14 };
	...
	{ "slotSetVerHistEqOnOff(int)", &slot_14, QMetaData::Public }
    };
...
bool VeriGUI::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 14: slotSetVerHistEqOnOff((int)static_QUType_int.get(_o+1)); break;
    default:
